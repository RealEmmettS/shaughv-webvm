...
<img src="assets/webvm_hero.png" alt="ShaughVM Logo" class="w-56 h-56 object-contain self-center">
<p>ShaughVM is a virtual Linux environment running in the browser via WebAssembly</p>
<p>It is based on:</p>
