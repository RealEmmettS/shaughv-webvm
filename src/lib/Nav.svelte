...
<nav class="flex items-center h-10 px-4 bg-black text-white">
	...
	<div class="flex items-center gap-4 text-sm">
		<a href="https://emmetts.dev" target="_blank" class="hover:text-gray-300">emmetts.dev</a>
		<a href="https://shaughv.com" target="_blank" class="hover:text-gray-300">shaughv.com</a>
	</div>
</nav>
